<template>
  ...
  <div class="container-fluid row mt-5">
    <div class="col-6 rounded-3">
      <img src="../assets/main.png" style="border-radius:25px; padding-left: 10px" alt="">
    </div>
    <div class="col-6 d-block m-auto">
      <div
          style="margin:auto; padding-top: 50px !important; padding-bottom: 60px !important; background-color: rgba(0,0,0,0.5)"
...
export default {
  ...
  setup() {
    ...
    const handleLogin = () => {
      ...
      loading.value = true;
      AuthService.login(formData.value).then((response) => {
